...
| 规则文件 | 类型 | 功能说明 |是否需要代理|
| :--- | :---: | :--- |:--- |
| [Apple_MS_Direct.list](./Apple_MS_Direct.list) | .list | 苹果&微软国内直连域名。 | DIRECT |
| [Bank_CN.list](./Bank_CN.list) | .list | 国内银行域名。 | DIRECT |
| [Bilibili_HMT.list](./Bilibili_HMT.list) | .list | 哔哩哔哩港澳台域名。 | 代理 |
| [BitComet_CDN.list](./BitComet_CDN.list) | .list | 比特彗星直连域名。 | DIRECT |
| [Check.list](./Check.list) | .list | 网络测速和检测域名。 | DIRECT |
| [Combined_Direct_Rules.list](./Combined_Direct_Rules.list) | .list | 国内CDN直连下载域名。 | DIRECT |
| [Custom_Port.list](./Custom_Port.list) | .list | 特殊端口。 | 代理 |
...
| [Telegram.list](./Telegram.list) | .list | 自动抓取Telegram相关域名。 | 代理 |
| [Xiaomi_IoT.list](./Xiaomi_IoT.list) | .list | 小米IoT相关域名。 | DIRECT |
| [YouTube_Video.list](./YouTube_Video.list) | .list | 油管代理补丁。 | 代理 |
